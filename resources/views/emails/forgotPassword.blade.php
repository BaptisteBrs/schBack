...
<head>
 ...
 <![endif]-->
    ...
    <!--<![endif]-->
    <title>Saint Cyr Herbignac - Changement de mot de passe</title>
    <!--[if gte mso 9]>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="img m-center"
                                                                ...
                                                                <img src="images/SCH.jpg" width="70"
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="text-center pb25"
                                                                style="color:#c1cddc; font-family:'Muli', Arial,sans-serif; font-size:16px; line-height:30px; text-align:center; padding-bottom:25px;">
                                                                Vous venez de recevoir un mail à partir du site officiel
                                                                du club de football <span
                                                                    class="m-hide"><br /></span>Saint Cyr Herbignac.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-center pb25"
                                                                style="color:#c1cddc; font-family:'Muli', Arial,sans-serif; font-size:16px; line-height:30px; text-align:center; padding-bottom:25px;">
                                                                Voici votre code de connexion pour changer votre mot de
                                                                passe <span
                                                                    class="m-hide"><br /></span>{{ $user->code_first_connexion }}
                                                                <br>
                                                                Il est actif jusqu'à
                                                                {{ $user->code_expired_at->format('d/m/Y H:i') }}
                                                            </td>
                                                        </tr>
                                                        <!-- Button -->
                                                        <tr>
                                                                        ...
                                                                        <td class="pink-button text-button"
                                                                            ...
                                                                            <a href="https://saintcyrherbignacfootball.fr/firstconnexion"
                                                                                ...
                                                                                style="color:#ffffff; text-decoration:none;"><span
                                                                                    class="link-white"
                                                                                    style="color:#ffffff; text-decoration:none;">Accèdez
                                                                                    ici à la page de modification de
                                                                                    votre mot de passe</span></a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    {{-- <table border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td class="img" width="55"
                                                                style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                <a href="https://www.facebook.com/profile.php?id=100030899512432"
                                                                    target="_blank"><img
                                                                        src="{{ url('images/emails/images/ico_facebook.jpg') }}"
                                                                        width="38" height="38" border="0"
                                                                        alt="" /></a>
                                                            </td>
                                                            <td class="img" width="55"
                                                                style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                <a href="https://instagram.com/scherbignac?igshid=YmMyMTA2M2Y%3D&fbclid=IwAR0O1fe__JHTO3ipm-BdLdu1z7Ry21T3ShHjXPdiyVKrQbYQDHa2RrdDEGM"
                                                                    target="_blank"><img
                                                                        src="{{ url('images/emails/ico_instagram.jpg') }}"
                                                                        width="38" height="38" border="0"
                                                                        alt="" /></a>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tr>
                                                <td class="text-footer1 pb10"
                                                    ...
                                                    Saint Cyr Herbignac Football</td>
                                            </tr>
                                            <tr>
                                                <td class="text-footer2"
                                                    ...
                                                    Stade Louis Brétecher<br />Avenue des Sports 44410 HERBIGNAC</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
